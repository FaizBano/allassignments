// 32. Checking Usernames: Do the following to create a program 
...
let current_users : string[] = ["Muhammad Ali","ShaFi","Abdul Rehman","Shahzad","Shakir Hussain"];
let newUser : string[] = ["Saleem Shah", "Muhammad Ali", "Mubin", "Asim","Shakir Hussain"];

...
let Guest_list :string[] =['Ms. Hina Naseer', 'Sir Zia Khan', 'Sir Kamran Khan Tessori'];
...
console.log('good news for all. we find a big table so we areinviting three more guest');
